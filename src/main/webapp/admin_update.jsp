...
<div class="navbar">
	...
	<c:set var="ob" value="${admin_data}" />

	<form action="/adminedit${ob.id }" method="post">
	<h1>Admin Update</h1>
		<input type="text" name="id" value="${ob.id} " readonly /> 
		Name<input type="text" name="name" value="${ob.name}" required/> 
		<br>
		<br> 
		Email: <input type="text" name="email" value="${ob.email}" required/>
		<br> 
		<br> 
		Phone: <input type="text" name="phone" value="${ob.phone}" required/> 
		<br> 
		<br>
		Password: <input type="text" name="password" value="${ob.password}" required/>
		<br> 
		<br>
