...
<div class="navbar">
    ...
    <form action="/useraddOrder${ob.pid}" method="post">
        <h1>Make Order</h1>
        ...
        Product Quantity Available (${ob.pqualtity}): 
        <input type="text" name="oqualtity" id="oquantity" oninput="calculateTotalPrice()" /> <br><br>
